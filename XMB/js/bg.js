...
function BgHandler() {
    ...
    if (!tmpBgImg && !customBgImg && !uiBgImg) {
        // Render all enabled effects through EffectsManager
        if (typeof EffectsManager !== 'undefined') {
            EffectsManager.Render();
        } else if ((typeof Waves !== 'undefined') && Waves && (typeof UserConfig !== 'undefined' && UserConfig.Waves)) {
...
function BgColorHandler() {
    ...
    if (typeof EffectsManager !== 'undefined') {
        EffectsManager.SetColor(color);
    } else if (typeof Waves !== 'undefined' && Waves && typeof Waves.SetColor === 'function') {
        // Fallback for backward compatibility
